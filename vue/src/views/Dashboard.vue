...
<PageComponent title="Dashboard">
  ...
  >
    ...
    <div
      class="row-span-2 bg-white shadow-md p-4 animate-fade-in-down order-3 lg:order-1"
    >
    <h3 class="text-2xl font-semibold">Latest Survey</h3>
        ...
        <div class="flex justify-between text-sm mb-1">
            <div>Expire Date:</div>
            <div>{{ data.latestSurvey.expire_date ? data.latestSurvey.expire_date : 'No expire date'}}</div>
        </div>
        <div class="flex justify-between text-sm mb-1">
            <div>Status:</div>
